...
public class RingShapeController extends AbstractShapeDialog {
    public RingShapeController(JDialog dialog) {
        super(dialog);
        initDialog();
    }
    ...
    public List<String> getImagePaths() {
        ...
        JFreeChartUtils.Ring(title, mapPay, moneyPay, pathPay);
        ...
        JFreeChartUtils.Ring(titleIn, mapIn, moneyIn, pathIn);
